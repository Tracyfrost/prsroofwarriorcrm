-- Exclude archived customers from global customer search.
...
COMMENT ON FUNCTION public.search_customers_global(text, integer) IS
  'Search active (non-archived) customers by name, customer #, address fields, contact_info, name_json, insurance, and related job claim/job_id.';
